<template>
  <div>
    ...
    <el-form inline :model="query" label-position="right" label-width="70px" class="query-form">
      <el-input v-model="query.logoKindName" placeholder="请输入类名称" style="width:150px;"></el-input>
      <el-form-item>
    ...
    <el-table :data="tableData" class="table" stripe border>
      ...
      <el-table-column prop="logoKindName" label="logo分类"></el-table-column>
    ...
    <el-dialog title="新增/编辑/查看" :visible.sync="addEditDialogVisible" width="800px">
      ...
      <el-form ref="infoForm" :model="infoForm" :rules="rules" label-width="150px">
        <el-form-item prop="logoKindName" label="logo主分类名称：">
          <el-input v-model="infoForm.logoKindName" :disabled="isCheck"></el-input>
        </el-form-item>
      </el-form>
...
import { list, remove, save, update } from "@/api/baseData/main_kind";
...
export default {
  ...
  methods: {
    ...
    getList: function() {
      let params = {
        logoKindName: this.query.logoKindName,
